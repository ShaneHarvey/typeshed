...
class GridFSBucket:
    ...
    def open_upload_stream(
        self, filename: Any, chunk_size_bytes: Optional[Any] = ..., metadata: Optional[Any] = ..., session: Optional[Any] = ...
    ): ...
    ...
    def download_to_stream_by_name(
        self, filename: Any, destination: Any, revision: int = ..., session: Optional[Any] = ...
    ) -> None: ...
