...
class PoolOptions:
    def __init__(self, max_pool_size: int=..., min_pool_size: int=..., max_idle_time_seconds: Optional[int]=..., connect_timeout: Optional[int]=..., socket_timeout: Optional[int]=..., wait_queue_timeout: Optional[int]=..., wait_queue_multiple: Optional[int]=..., ssl_context: Union[SSLContext, None]=..., ssl_match_hostname: bool=..., socket_keepalive: bool=..., event_listeners: Optional[_EventListeners]=..., appname: Optional[str]=..., driver: Optional[DriverInfo]=..., compression_settings: Optional[CompressionSettings]=...) -> None: ...
    @property
...
class SocketInfo:
    ...
    def command(self, dbname: Any, spec: Any, slave_ok: bool = ..., read_preference: Any = ..., codec_options: Any = ..., check: bool = ..., allowable_errors: Optional[Any] = ..., check_keys: bool = ..., read_concern: Optional[Any] = ..., write_concern: Optional[Any] = ..., parse_write_concern_error: bool = ..., collation: Optional[Any] = ..., session: Optional[Any] = ..., client: Optional[Any] = ..., retryable_write: bool = ..., publish_events: bool = ..., user_fields: Optional[Any] = ..., exhaust_allowed: bool = ...): ...
