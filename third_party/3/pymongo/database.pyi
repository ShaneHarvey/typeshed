...
class Database(common.BaseObject):
    ...
    def with_options(self, codec_options: Optional[Any] = ..., read_preference: Optional[Any] = ..., write_concern: Optional[Any] = ..., read_concern: Optional[Any] = ...): ...
    ...
    def create_collection(self, name: str, codec_options: Optional[CodecOptions]=..., read_preference: Optional[_ServerMode]=..., write_concern: Optional[WriteConcern]=..., read_concern: Optional[ReadConcern]=..., session: Optional[ClientSession]=..., **kwargs: Any) -> Collection: ...
    ...
    def command(self, command: Union[str, Mapping[str, Any]], value: int=..., check: bool=..., allowable_errors: Optional[Sequence[str]]=..., read_preference: _ServerMode=..., codec_options: CodecOptions=..., session: Optional[ClientSession]=..., **kwargs: Any) -> Any: ...
    ...
    def drop_collection(self, name_or_collection: Union[str, Collection], session: Optional[ClientSession]=...) -> Dict[str, Any]: ...
    def validate_collection(self, name_or_collection: Any, scandata: bool = ..., full: bool = ..., session: Optional[Any] = ..., background: Optional[Any] = ...): ...
    ...
    next: Any = ...
    def add_user(self, name: str, password: Optional[str]=..., read_only: Optional[bool]=..., session: Optional[ClientSession]=..., **kwargs: Any) -> None: ...
