...
def delete(
    collection_name: Any, spec: Any, safe: Any, last_error_args: Any, opts: Any, flags: int = ..., ctx: Optional[Any] = ...
): ...
...
class _BulkWriteContext:
    ...
    def legacy_write(
        self, request_id: int, msg: bytes, max_doc_size: int, acknowledged: bool, docs: Sequence[Mapping[str, Any]]
    ) -> Dict[str, Any]: ...
