...
class SSLContext:
    ...
    def wrap_socket(self, sock: Any, server_side: bool=..., do_handshake_on_connect: bool=..., suppress_ragged_eofs: bool=..., server_hostname: Optional[Any]=..., session: Optional[Any]=...) -> Any: ...
