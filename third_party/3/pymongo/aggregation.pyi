...
class _AggregationCommand:
    def __init__(self, target: Any, cursor_class: Any, pipeline: Any, options: Any, explicit_session: Any, user_fields: Optional[Any]=..., result_processor: Optional[Any]=...) -> None: ...
