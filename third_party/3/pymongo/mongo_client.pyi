...
class MongoClient(common.BaseObject):
    HOST: str = ...
    PORT: int = ...
    def __init__(self, host: Optional[Any] = ..., port: Optional[Any] = ..., document_class: Any = ..., tz_aware: Optional[Any] = ..., connect: Optional[Any] = ..., type_registry: Optional[Any] = ..., **kwargs: Any): ...
...
class _MongoClientErrorHandler:
    ...
    def __init__(self, client: Any, server: Any, session: Any) -> None: ...
