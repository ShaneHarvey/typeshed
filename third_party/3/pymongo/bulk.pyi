...
class _Bulk:
    ...
    def add_update(self, selector: Any, update: Any, multi: bool = ..., upsert: bool = ..., collation: Optional[Any] = ..., array_filters: Optional[Any] = ..., hint: Optional[Any] = ...) -> None: ...
    def add_replace(self, selector: Any, replacement: Any, upsert: bool = ..., collation: Optional[Any] = ..., hint: Optional[Any] = ...) -> None: ...
