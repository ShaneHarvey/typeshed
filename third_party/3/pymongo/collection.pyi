...
class Collection(common.BaseObject):
    def __init__(self, database: Database, name: str, create: Optional[bool]=..., codec_options: Optional[CodecOptions]=..., read_preference: Optional[_ServerMode]=..., write_concern: Optional[WriteConcern]=..., read_concern: Optional[ReadConcern]=..., session: Optional[ClientSession]=..., **kwargs: Any) -> None: ...
    ...
    def bulk_write(self, requests: Sequence[_WriteOp], ordered: bool=..., bypass_document_validation: bool=..., session: Optional[ClientSession]=...) -> BulkWriteResult: ...
    def insert_one(self, document: Any, bypass_document_validation: bool=..., session: Optional[ClientSession]=...) -> InsertOneResult: ...
    def insert_many(self, documents: Iterable[Any], ordered: bool=..., bypass_document_validation: bool=..., session: Optional[ClientSession]=...) -> InsertManyResult: ...
    def replace_one(self, filter: Any, replacement: Any, upsert: bool = ..., bypass_document_validation: bool = ..., collation: Optional[Any] = ..., hint: Optional[Any] = ..., session: Optional[Any] = ...): ...
    def update_one(self, filter: Any, update: Any, upsert: bool = ..., bypass_document_validation: bool = ..., collation: Optional[Any] = ..., array_filters: Optional[Any] = ..., hint: Optional[Any] = ..., session: Optional[Any] = ...): ...
    def update_many(self, filter: Any, update: Any, upsert: bool = ..., array_filters: Optional[Any] = ..., bypass_document_validation: bool = ..., collation: Optional[Any] = ..., hint: Optional[Any] = ..., session: Optional[Any] = ...): ...
    def drop(self, session: Optional[ClientSession]=...) -> None: ...
    def delete_one(self, filter: Any, collation: Optional[Any] = ..., hint: Optional[Any] = ..., session: Optional[Any] = ...): ...
    def delete_many(self, filter: Any, collation: Optional[Any] = ..., hint: Optional[Any] = ..., session: Optional[Any] = ...): ...
    ...
    def create_indexes(self, indexes: Sequence[IndexModel], session: Optional[ClientSession]=..., **kwargs: Any) -> List[str]: ...
    def create_index(self, keys: Union[str, Sequence[Tuple[str, Union[int, str]]], Mapping[str, Union[int, str]]], session: Optional[ClientSession]=..., **kwargs: Any) -> str: ...
    ...
    def aggregate(self, pipeline: Sequence[Mapping[str, Any]], session: Optional[ClientSession]=..., **kwargs: Any) -> CommandCursor: ...
    ...
    def distinct(self, key: str, filter: Optional[Mapping[str, Any]]=..., session: Optional[ClientSession]=..., **kwargs: Any) -> List[Any]: ...
    def map_reduce(self, map: str, reduce: str, out: Union[str, Mapping[str, Any]], full_response: bool=..., session: Optional[ClientSession]=..., **kwargs: Any) -> Union[Dict[str, Any], Database, Collection]: ...
    def inline_map_reduce(self, map: str, reduce: str, full_response: bool=..., session: Optional[ClientSession]=..., **kwargs: Any) -> Dict[str, Any]: ...
    def find_one_and_delete(self, filter: Any, projection: Optional[Any] = ..., sort: Optional[Any] = ..., hint: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs: Any): ...
    def find_one_and_replace(self, filter: Any, replacement: Any, projection: Optional[Any] = ..., sort: Optional[Any] = ..., upsert: bool = ..., return_document: Any = ..., hint: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs: Any): ...
    def find_one_and_update(self, filter: Any, update: Any, projection: Optional[Any] = ..., sort: Optional[Any] = ..., upsert: bool = ..., return_document: Any = ..., array_filters: Optional[Any] = ..., hint: Optional[Any] = ..., session: Optional[Any] = ..., **kwargs: Any): ...
