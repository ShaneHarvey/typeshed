...
class Server:
    def __init__(self, server_description: ServerDescription, pool: Pool, monitor: Monitor, topology_id: Optional[ObjectId]=..., listeners: Optional[_EventListeners]=..., events: Optional[Queue[Tuple[Callable[..., Any], Sequence[Any]]]]=...) -> None: ...
    def open(self) -> None: ...
    def reset(self) -> None: ...
    def close(self) -> None: ...
    def request_check(self) -> None: ...
    def run_operation_with_response(self, sock_info: Any, operation: Any, set_slave_okay: Any, listeners: Any, exhaust: Any, unpack_res: Any): ...
